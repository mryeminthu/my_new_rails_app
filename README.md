...
- Feel free to contribute, report issues, or make feature requests – your input is appreciated!
  Feel free to check the [issues page](https://github.com/mryeminthu/my_new_rails_app/issues).
...
This project is [MIT](https://github.com/mryeminthu/my_new_rails_app/blob/dev/LICENSE) licensed.
